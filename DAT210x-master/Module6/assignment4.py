...
# decision tree
treeModel = tree.DecisionTreeClassifier(max_depth=max_depth, random_state = 2)
...
benchmark(treeModel, X_train, X_test, y_train, y_test, 'SVC')
drawPlots(treeModel, X_train, X_test, y_train, y_test, 'SVC')
