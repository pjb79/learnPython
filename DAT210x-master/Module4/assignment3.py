...
#       ['bgr','wc','rc']
#
rowsToDrop = ['classification', 'rbc', 'pc', 'pcc', 'ba', 'htn', 'dm', 'cad', 'appet', 'pe', 'ane']
rowsToDrop = ['classification']
df.drop(rowsToDrop, axis = 1, inplace = True)
